...
class TestUltimateCTCACTransitProcessor(unittest.TestCase):
    ...
    def test_haversine_distance_calculation(self):
        ...
        # Should be approximately 25 miles (allowing 10% tolerance)
        self.assertGreater(distance_miles, 20)
        self.assertLess(distance_miles, 35)
    ...
    def test_calculate_ctcac_points_with_qualification(self):
        ...
        self.assertEqual(result['base_points'], 4)  # Qualifies for base points
