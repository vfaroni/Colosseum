...
"""
        ...
        for i, result in enumerate(results, 1):
            property_number = f"{i} of {len(results)}"
    ...
    def create_html_report(self, results: List[Dict]) -> str:
        """Create professional HTML report with enhanced styling"""
        ...
        for i, result in enumerate(results, 1):
            ...
            <div class="property">
                <div class="property-header error">
                    <div class="property-title">❌ {property_number}: {result['address']}</div>
...
"""
            ...
            <div class="property">
                <div class="property-header {cat_info['class']}">
                    <div class="property-title">{cat_info['emoji']} {property_number}: {result['address']}</div>
...
"""
            ...
            if demo and "error" not in demo:
                ...
                ami_4p_50pct = ""
                if ami and 'income_limits' in ami and '50_pct' in ami['income_limits']:
                    ami_4p_50pct = f"${ami['income_limits']['50_pct'].get('4p', 'N/A'):,}"
                ...
                if ami_4p_50pct:
                    html_content += f"""
                            <div class="detail-item">
                                ...
                                <span class="detail-value">{ami_4p_50pct}</span>
                            </div>"""
            ...
            if ami:
                html_content += f"""
                        <div class="detail-section">
                            ...
                            <div class="detail-item">
                                <span class="detail-label">1BR Rent:</span>
                                <span class="detail-value">${ami['rent_limits']['60_pct']['1br']} 60% / ${ami['rent_limits']['80_pct']['1br']} 80%</span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label">2BR Rent:</span>
                                <span class="detail-value">${ami['rent_limits']['60_pct']['2br']} 60% / ${ami['rent_limits']['80_pct']['2br']} 80%</span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label">3BR Rent:</span>
                                <span class="detail-value">${ami['rent_limits']['60_pct']['3br']} 60% / ${ami['rent_limits']['80_pct']['3br']} 80%</span>
                            </div>
                        </div>
"""
            ...
            if coords:
                ...
                # Census FactFinder URL for the tract
                census_tract = result.get('census_tract', '')
                census_url = f"https://data.census.gov/profile?g=1400000US{census_tract}" if census_tract else "#"
                ...
                html_content += f"""
                        <div class="detail-section">
                            ...
                            <div style="margin-top: 10px;">
                                <a href="{google_maps_url}" target="_blank" class="maps-link">📍 View on Google Maps</a>
                                <a href="{apple_maps_url}" target="_blank" class="maps-link apple">🍎 View on Apple Maps</a>
                                <a href="{census_url}" target="_blank" class="maps-link census-link">📊 Census Data</a>
                            </div>
                        </div>
"""
