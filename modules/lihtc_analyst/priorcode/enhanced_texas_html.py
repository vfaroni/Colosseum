...
"""
            ...
            <div class="property">
                <div class="property-header {cat_info['class']}">
                    <div class="property-title">{cat_info['emoji']} {result['address']}</div>
            ...
            if ami:
                html_content += f"""
                        <div class="detail-section">
                            ...
                            <div class="detail-item">
                                <span class="detail-label">1BR 50% Rent:</span>
                                <span class="detail-value">${ami['rent_limits']['50_pct']['1br']}</span>
                            </div>
                            <div class="detail-item">
                                <span class="detail-label">2BR 50% Rent:</span>
                                <span class="detail-value">${ami['rent_limits']['50_pct']['2br']}</span>
                            </div>
                        </div>
"""
