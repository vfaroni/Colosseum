...
import tempfile
from typing import Dict, List, Tuple, Optional, Union  # <-- THIS LINE FIXES List[Dict] errors
import time
import re
import math
from datetime import datetime, timedelta  # <-- THIS LINE FIXES datetime errors
import urllib.parse  # <-- THIS LINE NEEDED for URL encoding
